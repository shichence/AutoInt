...
def parse_args():
    ...
    parser.add_argument('--greater_is_better', type=str2bool, default=False, help='early stop criterion')
    parser.add_argument('--has_residual', type=str2bool, default=True, help='add residual or not')
